...
- (void)setWeico:(Weico *)weico
{
    ...
    // 转发
    [self setupBtnCount:weico.reposts_count btn:self.repostBtn title:@"转发"];
    // 评论
    [self setupBtnCount:weico.comments_count btn:self.commentBtn title:@"评论"];
    // 赞
    [self setupBtnCount:weico.attitudes_count btn:self.attitudeBtn title:@"赞"];
}
